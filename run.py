...
def main() -> int:
    if len(sys.argv) < 2:
        ...
        print("       python run.py [--trace] --liars puzzle.goblet-liars")
        print("       python run.py --labyrinth script.txt")
    ...
    if args and args[0] == "--liars":
        if len(args) != 2:
            print("usage: python run.py [--trace] --liars puzzle.goblet-liars")
            return 2
        try:
    ...
    if args and args[0] == "--labyrinth":
        if len(args) != 2:
            print("usage: python run.py --labyrinth script.txt")
            return 2
        try:
    ...
    if args and args[0] == "--labyrinth-random":
        if len(args) not in (2, 3):
            print("usage: python run.py --labyrinth-random script.txt [seed]")
            return 2
    ...
    if args and args[0] == "--labyrinth-random-play":
        if len(args) not in (1, 2):
            print("usage: python run.py --labyrinth-random-play [seed]")
            return 2
